#!/bin/bash
#Generated on 2023-01-19 05:11:55 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=76418587-c4c5-4e99-bea1-5a4d7e842223&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
